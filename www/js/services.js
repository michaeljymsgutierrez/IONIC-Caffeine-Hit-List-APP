var app = angular.module('caffeinehit.services', ['ngCordova']);
            ...
            ionic.Platform.ready(function(){
                ...
                .then(function(position){
                    ...
                    $ionicPopup.alert({
                        ...
                        'title': 'Pakiusap,Iaktibo ang iyong Geolocation',
                        'template': "Mukhang ang iyong Geolocation ay di aktibo"
                    })                    
                })
			...
			$http.get('https://codecraftpro.com/api/samples/v1/coffee/', {params: params})
				...
				.error(function (data, status, headers, config) {
					...
					deferred.reject(data);
                            ...
                            console.error("Error getting the position");
                            console.error(err);
                        });//ion
				});
